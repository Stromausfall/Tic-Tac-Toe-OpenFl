...
import net.matthiasauer.tictactoe.view.game.GameView;
import net.matthiasauer.tictactoe.view.menu.IMenuView;
import net.matthiasauer.tictactoe.view.menu.MenuView;
...
import net.matthiasauer.tictactoe.model.IGameManagerForModel;
...
class Main extends Sprite {	
	public function new () {
		...
		system.register(MenuView, [IMenuView]);
		...
		system.register(GameManager, [IGameManagerForView, IGameManagerForController, IGameManagerForModel]);
